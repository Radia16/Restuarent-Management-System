                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700">{{$count_outlet_id}}</h2>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700">{{$count_admin_id}}</h2>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700">{{$count_employee_id}}</h2>
            ...
            <div class="col-xl-3 col-lg-6 col-12">
                <div class="box">
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            <div>
                                <img src="../images/food/supplier.webp" class="w-80 me-20" alt="" />
                            </div>
                            <div>
                                <h2 class="my-0 fw-700">{{$count_supplier_id}}</h2>
                                <p class="text-fade mb-0">Total Supplier</p>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700">{{$count_customer_id}}</h2>
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="text-fade mb-0">Total Delievary Order</p>
                                <p class="fs-12 mb-0 text-primary"><span class="badge badge-pill badge-primary-light me-5"><i class="fa fa-arrow-down"></i></span>12% (15 Days)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="text-fade mb-0">Total Canceled Order</p>
                                <p class="fs-12 mb-0 text-success"><span class="badge badge-pill badge-success-light me-5"><i class="fa fa-arrow-up"></i></span>3% (15 Days)</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700 ">899</h2>
                                <p class="text-fade mb-0">Total Today Sale</p>
                                <p class="fs-12 mb-0 text-success"><span class="badge badge-pill badge-success-light me-5"><i class="fa fa-arrow-up"></i></span>8% (15 Days)</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h2 class="my-0 fw-700">{{$count_expense_id}}</h2>
                                <p class="text-fade mb-0">Total Expense</p>
                                <p class="fs-12 mb-0 text-primary"><span class="badge badge-pill badge-primary-light me-5"><i class="fa fa-arrow-down"></i></span>2% (15 Days)</p>
                            </div>
                        </div>
                    </div>
