    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form action="{{ url('weekend/store') }}" method="POST" >
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                <fieldset>
                                    <input type="checkbox" id="checkbox_7" name="weekends[]" value="friday"  data-validation-minchecked-message="Choose at least two" >
                                    <label for="checkbox_7">Friday</label>
                                {{--  </fieldset>
                                <fieldset>  --}}
                                    <input type="checkbox" id="checkbox_8" name="weekends[]" value="saturday"  data-validation-minchecked-message="Choose at least two" >
                                    <label for="checkbox_8">Saturday</label>
                                {{--  </fieldset>
                                <fieldset>  --}}
                                    <input type="checkbox" id="checkbox_9" name="weekends[]" value="sunday"  data-validation-minchecked-message="Choose at least two" >
