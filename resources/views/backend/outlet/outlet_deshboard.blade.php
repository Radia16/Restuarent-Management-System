                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h2 class="my-0 fw-700">{{$count_ingredient_id}}</h2>
                                            <p class="text-fade mb-0">Total Ingredient</p>
                                            <p class="fs-12 mb-0 text-primary"><span class="badge badge-pill badge-primary-light me-5"><i class="fa fa-arrow-down"></i></span>2% (15 Days)</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h2 class="my-0 fw-700">{{$count_kitchen_id}}</h2>
                                            <p class="text-fade mb-0">Total Kitchen</p>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h2 class="my-0 fw-700">{{$count_stock_id}}</h2>
                                            <p class="text-fade mb-0">Total Stock</p>
                                            <p class="fs-12 mb-0 text-primary"><span class="badge badge-pill badge-primary-light me-5"><i class="fa fa-arrow-down"></i></span>12% (15 Days)</p>
                                        </div>
                                    </div>
                                </div>
