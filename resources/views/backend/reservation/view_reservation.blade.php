                            ...
                            <table id="datatable-buttons"
                                ...
                                style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                                    <thead>
                                        ...
                                        aria-label="Name: activate to sort column descending">Outlet ID</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;"
                                            aria-label="Contact_Person: activate to sort column ascending">Table ID</th>
                                    ...
                                    <tbody>
                                        @foreach ($reservation_view as $r_view )
                                            <tr>
                                                ...
                                                <td class="sorting_1">{{ optional($r_view->outlets)->id }}</td>
                                                <td>{{$r_view->customer_name}}</td>
                                                <td>{{$r_view->table_id}}</td>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-5">
                <div class="dataTables_info"
                 id="datatable-buttons_info" role="status" aria-live="polite">
                ...
                <div class="dataTables_paginate paging_simple_numbers" id="datatable-buttons_paginate">
                    <ul class="pagination">
                       <li class="paginate_button page-item previous disabled" id="datatable-buttons_previous">
                        ...
                        <li class="paginate_button page-item ">
                            <a href="#" aria-controls="datatable-buttons" data-dt-idx="6"
